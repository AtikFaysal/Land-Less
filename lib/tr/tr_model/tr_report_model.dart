class TrReportById {
  int status;
  List<TrProjectData> trProjectData;

  TrReportById({this.status, this.trProjectData});

  TrReportById.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['tr_project_data'] != null) {
      trProjectData = new List<TrProjectData>();
      json['tr_project_data'].forEach((v) {
        trProjectData.add(new TrProjectData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.trProjectData != null) {
      data['tr_project_data'] =
          this.trProjectData.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class TrProjectData {
  ...
  TrProjectData.fromJson(Map<String, dynamic> json) {
