...
class TrImageWithLocation extends StatefulWidget {
  LoginResponse loginResponse;
  String trProjectId;

  TrImageWithLocation(this.loginResponse,this.trProjectId);

  @override
  _TrImageWithLocationState createState() => _TrImageWithLocationState(loginResponse,trProjectId);
}

class _TrImageWithLocationState extends State<TrImageWithLocation> {
  LoginResponse loginResponse;
  String trProjectId;


  _TrImageWithLocationState(this.loginResponse,this.trProjectId);
