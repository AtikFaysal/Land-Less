...
class UploadTrInfo extends StatefulWidget {
  LoginResponse loginResponse;
  String status;
  String kabikhaProjectId;


  UploadTrInfo(this.loginResponse, this.status, this.kabikhaProjectId);

  @override
  _UploadTrInfoState createState() => _UploadTrInfoState(loginResponse,status,kabikhaProjectId);
}

class _UploadTrInfoState extends State<UploadTrInfo> {
  LoginResponse loginResponse;
  String status;
  String trProjectId;

  _UploadTrInfoState(
      this.loginResponse, this.status, this.trProjectId);
        ...
        child: ElevatedButton.icon(
          ...
          onPressed: ()async{
            ...
            if(_image!=null && descriptionController.text.isNotEmpty && _verticalGroupValue!=null && _position!=null){
              ...
              DioApiCall().dioTrProjectInformationEntry(formData).then((value){
                if(value['status']==200){
                  setState(() {
                    _isLoading=false;
                  });
