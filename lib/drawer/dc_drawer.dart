...
import 'package:land_less/utils/dc_drawer_menu.dart';
...
class DcDrawer extends StatefulWidget {
  LoginResponse loginResponse;

  DcDrawer(this.loginResponse);

  @override
  _DcDrawerState createState() => _DcDrawerState(loginResponse);
}

class _DcDrawerState extends State<DcDrawer> {
  LoginResponse loginResponse;

  _DcDrawerState(this.loginResponse);
  ...
  @override
  void initState() {
    selectedMenuItemId = menuWithIconDc.items[0].id;
              ...
              new Container(
                  ...
                  decoration: new BoxDecoration(
                      ...
                      image: new DecorationImage(
                          ...
                          NetworkImage(''):AssetImage('assets/images/logo.png')))),
              Container(
