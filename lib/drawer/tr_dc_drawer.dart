...
import 'package:land_less/utils/tr_dcMenu.dart';
...
class Tr_DcDrawer extends StatefulWidget {
  LoginResponse loginResponse;

  Tr_DcDrawer(this.loginResponse);

  @override
  _Tr_DcDrawerState createState() => _Tr_DcDrawerState(loginResponse);
}

class _Tr_DcDrawerState extends State<Tr_DcDrawer> {
  LoginResponse loginResponse;

  _Tr_DcDrawerState(this.loginResponse);
  ...
  @override
  void initState() {
    selectedMenuItemId = menuWithIconDcTr.items[0].id;
      ...
      child: new MaterialApp(
        ...
        home: DrawerScaffold(
          ...
          builder: (context, id) => IndexedStack(
            index: id,
            children: menuWithIconDcTr.items
                .map((e) {
              if(e.id==0){
