...
class UploadHouseUpdate extends StatefulWidget {
  LoginResponse loginResponse;
  String status;
  String memberId;

  UploadHouseUpdate(this.loginResponse, this.status, this.memberId);

  @override
  _UploadHouseUpdateState createState() => _UploadHouseUpdateState(loginResponse,status,memberId);
}

class _UploadHouseUpdateState extends State<UploadHouseUpdate> {
  LoginResponse loginResponse;
  String status;
  String memberId;

  _UploadHouseUpdateState(this.loginResponse, this.status, this.memberId);
  ...
  Position _position;
  String _description;
  String _verticalGroupValue='ঘরের কাজ অসম্পন্ন';

  List<String> _status = ["ঘরের কাজ অসম্পন্ন", "ঘরের কাজ সম্পন্ন"];
    ...
    return Center(
        child: _image!=null?GestureDetector(
          ...
          onTap: () =>_showPicker(context),
            ...
            child: new Text('ঘরের ছবি নির্বাচন করুন',style: TextStyle(color: AppTheme.subColors,fontSize: 18,fontWeight: FontWeight.w500),),
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          labelText: "ঘরের বিস্তারিত লিখুন",
          labelStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w400),
          fillColor: Colors.white,
          hintText: "ঘরের বিস্তারিত",
          ...
          onPressed: ()async{
            ...
            if(_image!=null && descriptionController.text.isNotEmpty && _verticalGroupValue!=null && _position!=null){
              FormData formData=FormData.fromMap({
                ...
                'status':_verticalGroupValue.trim()=='ঘরের কাজ অসম্পন্ন'?'0':'1',
                'member_id':memberId,
              ...
              DioApiCall().dioHouseInformationEntry(formData).then((value){
                if(value['status']==200){
                  setState(() {
                    _isLoading=false;
                  });
                  successToast(context, ' সফলভাবে ঘরের তথ্য সংরক্ষণ হয়েছে');
                  Navigator.of(context).pop();
                }else if(value['status']==401){
                  setState(() {
                    _isLoading=false;
                  });
                  showToastMassage(context, 'দুঃখিত ! ঘরের তথ্য সংরক্ষণ হয়নি');
