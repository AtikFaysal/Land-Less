class PublicMemberById {
  int status;
  List<PuSingleMemberData> puSingleMemberData;

  PublicMemberById({this.status, this.puSingleMemberData});

  PublicMemberById.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['pu_single_member_data'] != null) {
      puSingleMemberData = new List<PuSingleMemberData>();
      json['pu_single_member_data'].forEach((v) {
        puSingleMemberData.add(new PuSingleMemberData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.puSingleMemberData != null) {
      data['pu_single_member_data'] =
          this.puSingleMemberData.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class PuSingleMemberData {
  String memberId;
  String memberName;
  String type;
  String fatherName;
  ...
  PuSingleMemberData.fromJson(Map<String, dynamic> json) {
